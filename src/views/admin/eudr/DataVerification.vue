...
export default {
  ...
  methods: {
    ...
    viewBlockchainRecord(record) {
      console.log('View blockchain record:', record);
    },
    
    reverifyRecord(record) {
      console.log('Reverify record:', record);
    },
    ...
    reverifyDocument(document) {
      console.log('Reverify document:', document);
    }
  }
};
</script>
