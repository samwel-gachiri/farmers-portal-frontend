...
export default {
  ...
  methods: {
    ...
    async onZoneSelected(zoneId) {
      ...
      try {
        ...
        const response = await this.$http.get(`/api/zone-supervisor-service/zones/${zoneId}/farmers`)
  ...
  async optimizeRoute() {
      ...
      try {
        ...
        const response = await this.$http.get(`/api/zone-supervisor-service/zones/${this.selectedZone}/optimal-route`)
    ...
    async confirmSchedulePickups() {
      ...
      try {
        ...
        const promises = this.optimizedRoute.optimizedOrder.map((farmerId, index) => {
          ...
          return this.$http.post('/api/zone-supervisor-service/pickup-schedules', {
            farmerId,
