...
class DeforestationAlertService {
    ...
    async getAlertsForProductionUnit(productionUnitId, startDate = null, endDate = null, severity = null) {
        try {
            ...
            console.error('Failed to get alerts for production unit:', error)
            throw error
        }
    }
    ...
    async checkIntegrity(alertIds) {
        try {
            ...
            console.error('Failed to check alert integrity:', error)
            throw error
        }
    }
    ...
    async getAlertsByFarmer(farmerId, daysSince = 30) {
        try {
            ...
            console.error('Failed to get alerts by farmer:', error)
            throw error
        }
    }
